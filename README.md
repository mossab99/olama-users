...
- Temp Families receive grade/section-based Student Gateway access only. They are not linked to existing Core students; family profile, finance, transportation, WordPress administration, and student-specific records remain unavailable by default.
