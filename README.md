...
- OLAMA Users is the authority allowed to create OLAMA roles and grant declared plugin capabilities. Administrators may also assign approved non-Administrator OLAMA roles from WordPress' native Users screens; nonce-verified native assignments use the same role capability grants.
